...
gars_diagram = pathlib.Path(__file__).parent.resolve() / "../erdiagram-autogen" / "gars.md"
fix_diagram(gars_yaml, gars_diagram)

libgen_yaml = pathlib.Path(__file__).parent.resolve() / "../linkml-schema" / "library_generation.yaml"
libgen_diagram = pathlib.Path(__file__).parent.resolve() / "../erdiagram-autogen" / "library_generation.md"
