...
class AmplifiedCdna(ProvEntity, MaterialSample):
    ...
    name: Optional[str] = Field(default=None, description="""Name of a collection of cDNA molecules derived and amplified from an input barcoded_cell_sample.  These cDNA molecules represent the gene expression of each cell, with all cDNA molecules from a given cell retaining that cell's unique barcode from the cell barcoding step.  This is a necessary step for GEX methods but is not used for ATAC methods.""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         ...
         'narrow_mappings': ['dct:title', 'WIKIDATA_PROPERTY:P1476'],
         'slot_uri': 'bican:e2606a11-114e-472f-9e05-33f9b6fc3089'} })
    quantity_ng: Optional[float] = Field(default=None, description="""Amount of cDNA produced after cDNA amplification measured in nanograms.""", json_schema_extra = { "linkml_meta": {'alias': 'quantity_ng',
    ...
    pass_fail_result: Optional[AmplifiedCdnaRnaAmplificationPassFail] = Field(default=None, description="""Pass or Fail result based on qualitative assessment of cDNA yield and size.""", json_schema_extra = { "linkml_meta": {'alias': 'pass_fail_result',
         'domain_of': ['AmplifiedCdna', 'Library'],
...
class Library(ProvEntity, MaterialSample):
    ...
    pass_fail_result: Optional[LibraryPrepPassFail] = Field(default=None, description="""Pass or Fail result based on qualitative assessment of library yield and size.""", json_schema_extra = { "linkml_meta": {'alias': 'pass_fail_result',
         'domain_of': ['AmplifiedCdna', 'Library'],
    ...
    quantity_ng: Optional[float] = Field(default=None, description="""Amount of library generated in terms of nanograms""", json_schema_extra = { "linkml_meta": {'alias': 'quantity_ng',
         'domain_of': ['AmplifiedCdna', 'Library'],
...
class CdnaAmplification(ProvActivity, Procedure):
    ...
    process_date: Optional[date] = Field(default=None, description="""Date of cDNA amplification.""", json_schema_extra = { "linkml_meta": {'alias': 'process_date',
         'domain_of': ['CellDissociation',
                       'CellEnrichment',
                       'CellBarcoding',
                       'CdnaAmplification',
    ...
    set: Optional[str] = Field(default=None, description="""cDNA amplification set, containing multiple amplified_cDNA_names that were processed at the same time.""", json_schema_extra = { "linkml_meta": {'alias': 'set',
...
class LibraryConstruction(ProvActivity, Procedure):
    ...
    process_date: Optional[date] = Field(default=None, description="""Date of library construction.""", json_schema_extra = { "linkml_meta": {'alias': 'process_date',
         'domain_of': ['CellDissociation',
                       'CellEnrichment',
                       'CellBarcoding',
                       'CdnaAmplification',
    ...
    set: Optional[str] = Field(default=None, description="""Library set, containing multiple library_names that were processed at the same time.""", json_schema_extra = { "linkml_meta": {'alias': 'set',
         'domain_of': ['CdnaAmplification', 'LibraryConstruction'],
