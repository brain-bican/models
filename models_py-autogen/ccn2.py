...
class Taxonomy(ConfiguredBaseModel):
    ...
    classifying_ontology_term_name: str = Field(..., description="""The name of the ontology term in the classification_id column""")
...
class CrossTaxonomyMapping(ConfiguredBaseModel):
    ...
    mapped_cell_type_name: str = Field(..., description="""The name of the cell type corresponding to the mapped_cell_set_accession.""")
...
class LocationMapping(ConfiguredBaseModel):
    ...
    location_ontology_term_name: str = Field(..., description="""Name of the term whose ID is recorded in the ontology_term_id field.""")
