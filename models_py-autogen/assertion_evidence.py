...
class Assertion(ConfiguredBaseModel):
    ...
    significance_level: Optional[SignificanceLevel] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'brainkb:significance_level',
         'domain_of': ['Assertion'],
         'slot_uri': 'brainkb:significance_level'} })
    significance_type: Optional[Significance] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'brainkb:significance_type',
         'domain_of': ['Assertion'],
