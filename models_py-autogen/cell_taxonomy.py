...
linkml_meta = LinkMLMeta({'default_prefix': 'bican',
     ...
     'id': 'https://w3id.org/brain-bican/cell-taxonomy',
     ...
     'source_file': 'cell_taxonomy.yaml',
     'subsets': {'X': {'description': 'Location within anndata object that stores '
                                      'data.',
                       'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                       'name': 'X'},
                 'analysis': {'description': 'AIT assigned label to tag attributes '
                                             'representing analysis.',
                              'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                              'name': 'analysis'},
                 'annotations': {'description': 'AIT assigned label to tag '
                                                'attributes representing '
                                                'annotations.',
                                 'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                                 'name': 'annotations'},
                 'assigned_metadata': {'description': 'AIT assigned label to tag '
                                                      'attributes representing '
                                                      'assigned metadata.',
                                       'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                                       'name': 'assigned_metadata'},
                 'data': {'description': 'AIT assigned label to tag attributes '
                                         'representing data.',
                          'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                          'name': 'data'},
                 'obs': {'description': 'Location within anndata object that '
                                        'stores cell metadata.',
                         'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                         'name': 'obs'},
                 'obsm': {'description': 'Location within anndata object that '
                                         'stores cell-shaped matrices.',
                          'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                          'name': 'obsm'},
                 'raw': {'description': 'Location within anndata object that '
                                        'stores data.',
                         'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                         'name': 'raw'},
                 'tooling': {'description': 'AIT assigned label to tag attributes '
                                            'representing tooling.',
                             'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                             'name': 'tooling'},
                 'uns': {'description': 'Location within anndata object that '
                                        'stores header and everything else.',
                         'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                         'name': 'uns'},
                 'var': {'description': 'Location within anndata object that '
                                        'stores gene metadata.',
                         'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                         'name': 'var'},
                 'varm': {'description': 'Location within anndata object that '
                                         'stores gene-shaped metadata.',
                          'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
                          'name': 'varm'}},
     'title': 'Cell Taxonomy Schema'} )
...
class ExpressionMatrixType(str, Enum):
...
class OrganismTaxon(NamedThing):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'aliases': ['taxon', 'taxonomic classification'],
         ...
         'slot_usage': {'has taxonomic rank': {'mappings': ['WIKIDATA:P105'],
                                               'multivalued': False,
...
class StudyResult(InformationContentEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True,
         ...
         'from_schema': 'https://w3id.org/biolink/bican-biolink-schema',
         'notes': ['The data/metadata included in a Study Result object are typically '
                   'a subset of data from a larger study data set, that are selected '
                   'by a curator because they may be useful as evidence for deriving '
                   'knowledge about a specific focus of the study. The notion of a '
                   "'study' here is defined broadly to include any research activity "
                   'at any scale that is aimed at generating knowledge or hypotheses. '
                   'This may include a single assay or computational analyses, or a '
...
class RelativeFrequencyAnalysisResult(StudyResult):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'biolink:RelativeFrequencyAnalysisResult',
...
class MacromolecularMachineMixin(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'biolink:MacromolecularMachineMixin',
         ...
         'from_schema': 'https://w3id.org/biolink/bican-biolink-schema',
         'mixin': True,
         'slot_usage': {'name': {'description': 'genes are typically designated by a '
                                                'short symbol and a full name. We map '
                                                'the symbol to the default display '
                                                'name and use an additional slot for '
                                                'full name',
                                 'name': 'name',
                                 'range': 'symbol type'}}})
...
class ProvActivity(ConfiguredBaseModel):
    ...
    used: Optional[str] = Field(default=None, description="""Usage is the beginning of utilizing an entity by an activity. Before usage, the activity had not begun to utilize this entity and could not have been affected by the entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ProvActivity'], 'slot_uri': 'prov:used'} })
...
class GenomeAnnotation(Genome):
    ...
    content_url: Optional[list[str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['GenomeAnnotation', 'CellTypeTaxonomy', 'ExpressionMatrix'],
         'slot_uri': 'schema:url'} })
...
class Cell(ProvEntity, NamedThing):
    """
    ...
    equivalent_identifiers: Optional[list[str]] = Field(default=None, description="""A set of identifiers that are considered equivalent to the primary identifier of the entity. This attribute is used to represent a collection of identifiers that are considered equivalent to the primary identifier of an entity. These equivalent identifiers may come from different databases, ontologies, or naming conventions, but they all refer to the same underlying concept or entity. This attribute is particularly useful in data integration and interoperability scenarios, where it is important to recognize and link different representations of the same entity across various sources.""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/equivalent_identifiers',
         ...
         'see_also': ['biolink:xref', 'biolink:synonyms'],
         'slot_uri': 'biolink:equivalent_identifiers'} })
    category: list[Literal["https://identifiers.org/brain-bican/vocab/Cell","bican:Cell"]] = Field(default=["bican:Cell"], description="""Name of the high level ontology class in which this entity is categorized. Corresponds to the label for the biolink entity type class. In a neo4j database this MAY correspond to the neo4j label tag. In an RDF database it should be a biolink model class URI. This field is multi-valued. It should include values for ancestors of the biolink class; for example, a protein such as Shh would have category values `biolink:Protein`, `biolink:GeneProduct`, `biolink:MolecularEntity`. In an RDF database, nodes will typically have an rdf:type triples. This can be to the most specific biolink class, or potentially to a class more specific than something in biolink. For example, a sequence feature `f` may have a rdf:type assertion to a SO class such as TF_binding_site, which is more specific than anything in biolink. Here we would have categories {biolink:GenomicEntity, biolink:MolecularEntity, biolink:NamedThing}""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/category',
         'designates_type': True,
         'domain': 'entity',
         'domain_of': ['entity'],
         'in_subset': ['translator_minimal'],
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/brain-bican/cell-taxonomy',
         ...
         'slot_usage': {'id': {'description': 'Unique identifier for this cluster set.',
                        ...
                        'name': {'description': 'Human-readable name for this cluster '
                                 ...
                                 'name': 'name',
                                 'range': 'string'},
                        'was_derived_from': {'multivalued': True,
                                             'name': 'was_derived_from',
...
class ExpressionMatrix(ProvEntity, NamedThing):
    """
    ...
    equivalent_identifiers: Optional[list[str]] = Field(default=None, description="""A set of identifiers that are considered equivalent to the primary identifier of the entity. This attribute is used to represent a collection of identifiers that are considered equivalent to the primary identifier of an entity. These equivalent identifiers may come from different databases, ontologies, or naming conventions, but they all refer to the same underlying concept or entity. This attribute is particularly useful in data integration and interoperability scenarios, where it is important to recognize and link different representations of the same entity across various sources.""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/equivalent_identifiers',
         ...
         'see_also': ['biolink:xref', 'biolink:synonyms'],
         'slot_uri': 'biolink:equivalent_identifiers'} })
    category: list[Literal["https://identifiers.org/brain-bican/vocab/ExpressionMatrix","bican:ExpressionMatrix"]] = Field(default=["bican:ExpressionMatrix"], description="""Name of the high level ontology class in which this entity is categorized. Corresponds to the label for the biolink entity type class. In a neo4j database this MAY correspond to the neo4j label tag. In an RDF database it should be a biolink model class URI. This field is multi-valued. It should include values for ancestors of the biolink class; for example, a protein such as Shh would have category values `biolink:Protein`, `biolink:GeneProduct`, `biolink:MolecularEntity`. In an RDF database, nodes will typically have an rdf:type triples. This can be to the most specific biolink class, or potentially to a class more specific than something in biolink. For example, a sequence feature `f` may have a rdf:type assertion to a SO class such as TF_binding_site, which is more specific than anything in biolink. Here we would have categories {biolink:GenomicEntity, biolink:MolecularEntity, biolink:NamedThing}""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/category',
         'designates_type': True,
         'domain': 'entity',
         'domain_of': ['entity'],
         'in_subset': ['translator_minimal'],
...
class Embedding(ProvEntity, NamedThing):
    """
    ...
    equivalent_identifiers: Optional[list[str]] = Field(default=None, description="""A set of identifiers that are considered equivalent to the primary identifier of the entity. This attribute is used to represent a collection of identifiers that are considered equivalent to the primary identifier of an entity. These equivalent identifiers may come from different databases, ontologies, or naming conventions, but they all refer to the same underlying concept or entity. This attribute is particularly useful in data integration and interoperability scenarios, where it is important to recognize and link different representations of the same entity across various sources.""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/equivalent_identifiers',
         ...
         'see_also': ['biolink:xref', 'biolink:synonyms'],
         'slot_uri': 'biolink:equivalent_identifiers'} })
    category: list[Literal["https://identifiers.org/brain-bican/vocab/Embedding","bican:Embedding"]] = Field(default=["bican:Embedding"], description="""Name of the high level ontology class in which this entity is categorized. Corresponds to the label for the biolink entity type class. In a neo4j database this MAY correspond to the neo4j label tag. In an RDF database it should be a biolink model class URI. This field is multi-valued. It should include values for ancestors of the biolink class; for example, a protein such as Shh would have category values `biolink:Protein`, `biolink:GeneProduct`, `biolink:MolecularEntity`. In an RDF database, nodes will typically have an rdf:type triples. This can be to the most specific biolink class, or potentially to a class more specific than something in biolink. For example, a sequence feature `f` may have a rdf:type assertion to a SO class such as TF_binding_site, which is more specific than anything in biolink. Here we would have categories {biolink:GenomicEntity, biolink:MolecularEntity, biolink:NamedThing}""", json_schema_extra = { "linkml_meta": {'definition_uri': 'https://w3id.org/biolink/vocab/category',
         'designates_type': True,
         'domain': 'entity',
         'domain_of': ['entity'],
         'in_subset': ['translator_minimal'],
