...
linkml_meta = LinkMLMeta({'default_prefix': 'bican',
     ...
     'imports': ['linkml:types', 'anatomical_structure_core', 'bican_biolink'],
     'license': 'MIT',
...
class NamedThing(Entity):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True,
         'from_schema': 'https://identifiers.org/brain-bican/anatomical-structure-core-schema'})
...
class VersionedNamedThing(NamedThing):
    ...
    revision_of: Optional[VersionedNamedThing] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of', 'domain_of': ['VersionedNamedThing']} })
...
class ImageDataset(VersionedNamedThing):
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[ImageDataset, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
...
class AnatomicalSpace(VersionedNamedThing):
    ...
    measures: Union[ImageDataset, str] = Field(default=..., description="""Reference to the specific image dataset used to define the anatomical space.""", json_schema_extra = { "linkml_meta": {'alias': 'measures',
         'any_of': [{'range': 'ImageDataset'}, {'range': 'string'}],
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[AnatomicalSpace, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
...
class ParcellationTerminology(VersionedNamedThing):
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[ParcellationTerminology, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
...
class ParcellationTermSet(NamedThing):
    ...
    part_of_parcellation_terminology: Union[ParcellationTerminology, str] = Field(default=..., description="""Reference to the parcellation terminology for which the parcellation term set partitions.""", json_schema_extra = { "linkml_meta": {'alias': 'part_of_parcellation_terminology',
         'any_of': [{'range': 'ParcellationTerminology'}, {'range': 'string'}],
    ...
    has_parent_parcellation_term_set: Optional[Union[ParcellationTermSet, str]] = Field(default=None, description="""Reference to the parent parcellation term set for which the parcellation term set is a child  (lower taxonomic rank) of.""", json_schema_extra = { "linkml_meta": {'alias': 'has_parent_parcellation_term_set',
...
class ParcellationTerm(NamedThing):
    ...
    part_of_parcellation_term_set: Union[ParcellationTermSet, str] = Field(default=..., description="""Reference to the parcellation term set for which the parcellation term is part of.""", json_schema_extra = { "linkml_meta": {'alias': 'part_of_parcellation_term_set',
         'any_of': [{'range': 'ParcellationTermSet'}, {'range': 'string'}],
    ...
    has_parent_parcellation_term: Optional[Union[ParcellationTerm, str]] = Field(default=None, description="""Reference to the parent parcellation term for which the parcellation term is a child ( spatially part) of""", json_schema_extra = { "linkml_meta": {'alias': 'has_parent_parcellation_term',
...
class ParcellationColorScheme(VersionedNamedThing):
    ...
    subject_parcellation_terminology: Union[ParcellationTerminology, str] = Field(default=..., description="""Reference to the parcellation terminology for which the parcellation color scheme is in  context of.""", json_schema_extra = { "linkml_meta": {'alias': 'subject_parcellation_terminology',
         'any_of': [{'range': 'ParcellationTerminology'}, {'range': 'string'}],
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[ParcellationColorScheme, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
...
class ParcellationColorAssignment(ConfiguredBaseModel):
    ...
    part_of_parcellation_color_scheme: Union[ParcellationColorScheme, str] = Field(default=..., description="""Reference to the parcellation color scheme for which the color assignment is part of.""", json_schema_extra = { "linkml_meta": {'alias': 'part_of_parcellation_color_scheme',
         'any_of': [{'range': 'ParcellationColorScheme'}, {'range': 'string'}],
         'domain_of': ['ParcellationColorAssignment']} })
    subject_parcellation_term: Union[ParcellationTerm, str] = Field(default=..., description="""Reference to the parcellation term identifier for which the color assignment is about.""", json_schema_extra = { "linkml_meta": {'alias': 'subject_parcellation_term',
         'any_of': [{'range': 'ParcellationTerm'}, {'range': 'string'}],
...
class AnatomicalAnnotationSet(VersionedNamedThing):
    ...
    parameterizes: Union[AnatomicalSpace, str] = Field(default=..., description="""Reference to the anatomical space for which the anatomical annotation set is anchored""", json_schema_extra = { "linkml_meta": {'alias': 'parameterizes',
         'any_of': [{'range': 'AnatomicalSpace'}, {'range': 'string'}],
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[AnatomicalAnnotationSet, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
...
class ParcellationAnnotation(ConfiguredBaseModel):
    ...
    part_of_anatomical_annotation_set: Union[AnatomicalAnnotationSet, str] = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'part_of_anatomical_annotation_set',
         'any_of': [{'range': 'AnatomicalAnnotationSet'}, {'range': 'string'}],
...
class ParcellationAnnotationTermMap(ConfiguredBaseModel):
    ...
    subject_parcellation_term: Union[ParcellationTerm, str] = Field(default=..., description="""Reference to the parcellation term that is the subject of the association.""", json_schema_extra = { "linkml_meta": {'alias': 'subject_parcellation_term',
         'any_of': [{'range': 'ParcellationTerm'}, {'range': 'string'}],
         'domain_of': ['ParcellationColorAssignment', 'ParcellationAnnotationTermMap']} })
...
class ParcellationAtlas(VersionedNamedThing):
    ...
    has_anatomical_space: Union[AnatomicalSpace, str] = Field(default=..., description="""Reference to the anatomical space component of the parcellation atlas""", json_schema_extra = { "linkml_meta": {'alias': 'has_anatomical_space',
         'any_of': [{'range': 'AnatomicalSpace'}, {'range': 'string'}],
         'domain_of': ['ParcellationAtlas']} })
    has_anatomical_annotation_set: Union[AnatomicalAnnotationSet, str] = Field(default=..., description="""Reference to the anatomical annotation set component of the parcellation atlas""", json_schema_extra = { "linkml_meta": {'alias': 'has_anatomical_annotation_set',
         'any_of': [{'range': 'AnatomicalAnnotationSet'}, {'range': 'string'}],
         'domain_of': ['ParcellationAtlas']} })
    has_parcellation_terminology: Union[ParcellationTerminology, str] = Field(default=..., description="""Reference to the parcellation terminology component of the parcellation atlas""", json_schema_extra = { "linkml_meta": {'alias': 'has_parcellation_terminology',
         'any_of': [{'range': 'ParcellationTerminology'}, {'range': 'string'}],
         'domain_of': ['ParcellationAtlas']} })
    specialization_of: Optional[Union[ParcellationAtlas, str]] = Field(default=None, description="""Reference to the general (non versioned) parcellation atlas for which the parcellation atlas is a specific  version release of.""", json_schema_extra = { "linkml_meta": {'alias': 'specialization_of',
    ...
    version: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'version',
         ...
         'is_a': 'node property',
         'slot_uri': 'biolink:version'} })
    revision_of: Optional[Union[ParcellationAtlas, str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'revision_of',
         'any_of': [{'range': 'ParcellationAtlas'}, {'range': 'string'}],
         'domain_of': ['VersionedNamedThing']} })
