...
linkml_meta = LinkMLMeta({'default_prefix': 'bican',
     ...
     'description': 'The BICAN Core schema is designed to represent classes, '
                    'slots, and enums that are frequently used in BICAN schemas.',
